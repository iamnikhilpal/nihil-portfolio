    ...
    return (
        <>
            ...
            <div className={`fixed inset-0 z-50 flex items-center justify-center transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <div className={`relative bg-white rounded-2xl w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto transform transition-all duration-300 shadow-xl border border-[#E1B07E]/20 ${isClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 p-6">
                        <div className="relative h-[300px] md:h-[400px] group">
                            <div className="relative w-full h-full bg-[#F5EFE6] rounded-lg">
                                <Image src={images[currentImageIndex]} alt={product.title} fill className="object-contain transition-opacity duration-300" sizes="(max-width: 768px) 100vw, 50vw" />
                            </div>
                        </div>
                        <div className="flex flex-col">
                            <div className="flex flex-row items-center mb-2 gap-x-4 pr-12 flex-wrap min-w-0">
                            ...
                            <div className="flex flex-row items-center gap-x-4 mb-2">
                                <button onClick={() => { navigator.clipboard.writeText(window.location.href); toast.success('Link copied to clipboard!'); }} className="rounded-full hover:bg-[#B08BBB]/10 text-[#2C2C2C] transition-colors flex-shrink-0" title="Copy Link">
                            ...
                            <div className="mt-auto space-y-4">
                                ...
                                <div className="grid grid-rows-1 gap-4">
                                    <button className="bg-[#B08BBB] hover:bg-[#9A3324] text-white px-6 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-md flex items-center justify-center gap-2" disabled>Contact Us</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
const products: Product[] = [
    ...
    },
    {
        ...
        * Traditional toran for your home
        ...
        image: '/DIL SE DIWALI HAMPER-002.png',
        priceRange: '₹699 – ₹999',
        articleId: 'B1020251',
    }
];
    ...
    return (
        <div className="min-h-screen bg-[#F5EFE6]">
            ...
            <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled
                ...
                <div className="max-w-6xl mx-auto px-6 w-full flex items-center justify-between py-4">
                    <div className="flex items-center space-x-4">
                        <Link href="/products" className="flex items-center">
                            <div className="w-24 h-10 sm:w-32 sm:h-12 relative flex items-center justify-center">
                                <Image
                                    src="/vanika.png"
                                    alt="Vanika Logo"
                                    fill
            ...
            < section className="pt-32 pb-20 relative min-h-[80vh] flex items-center" >
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-6xl font-bold mb-4 text-[#9A3324] drop-shadow-sm">
                            Celebrate Diwali in Style
                        </h1>
                        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-[#B08BBB]">
            ...
            {/* Home Banner Section */}
            <section id="home-banner" className="w-full bg-[#F5EFE6] py-16 flex flex-col items-center justify-center">
                {/* ...existing home banner content... */}
            </section>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
                        {products.map((product) => {
                            ...
                            return (
                                <div
                                    key={product.id}
                                    className="bg-white rounded-2xl overflow-hidden border border-[#E1B07E]/30 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col h-full group min-h-[500px]"
                                >
                                    ...
                                    <div className="p-8 flex flex-col flex-grow space-y-4 justify-between">
                                        <h3 className="text-xl font-bold text-[#B08BBB] group-hover:text-[#9A3324] transition-colors duration-300 leading-tight min-h-[3.5rem]">
                                            {product.title}
            ...
            {/* Contact Section */}
            <section id="contact-section" className="py-12 bg-[#F5EFE6] border-t border-[#E1B07E]/20" >
                <div className="max-w-6xl mx-auto px-6">
                    <div className="bg-white rounded-2xl p-8 border border-[#E1B07E]/30 shadow-lg">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="flex items-center space-x-4 justify-center md:justify-start">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:vanikacreations2025@gmail.com" className="text-[#2C2C2C]/80 hover:text-[#B08BBB] transition-colors">
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-[#2C2C2C] mb-4">Follow us on Instagram for the latest updates and offers:</p>
                            <a
                                href="https://www.instagram.com/vanika_creations_/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center gap-2 bg-[#B08BBB] hover:bg-[#9A3324] text-white px-6 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 shadow-md"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm4.25 3.25a5.25 5.25 0 1 1 0 10.5a5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5zm5.25.75a1 1 0 1 1-2 0a1 1 0 0 1 2 0z" /></svg>
                                @vanika_creations_
                            </a>
            ...
            {/* Footer */}
            <div className="mt-8 text-center text-base text-[#525252]">
